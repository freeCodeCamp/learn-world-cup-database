...
describe('SUBTASKS 1.1', async () => {
  ...
  it(':9 Your "insert_data.sh" script should add each unique team to the "teams" table', async () => {
    const teamNames = ['France','Croatia','Belgium','England','Russia','Sweden','Brazil','Uruguay','Colombia','Switzerland','Japan','Mexico','Denmark','Spain','Portugal','Argentina','Germany','Netherlands','Costa Rica','Chile','Algeria','Nigeria','Greece','USA'];
